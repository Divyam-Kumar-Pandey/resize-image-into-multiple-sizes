        ...
        {!file && (
          <section className="py-16 md:py-24 text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-on-surface mb-6 max-w-3xl mx-auto leading-tight font-headline">
              Turn one image into multiple sizes <br/>fast and free
            </h1>
            <p className="text-lg text-secondary mb-12 max-w-2xl mx-auto font-body leading-relaxed">
              Upload a single photo and export every width and height you need in one go—ZIP download, no uploads to a server, no tracking.
            </p>
            ...
            >
              <div className="flex flex-col items-center justify-center space-y-4 pointer-events-none">
                ...
                <div>
                  <p className="text-xl font-headline font-bold text-on-surface">Drag your image here</p>
        ...
        <section className="py-20 border-t border-stone-200 mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="space-y-4">
              ...
              <p className="text-secondary leading-relaxed">Drop one high-resolution image into the canvas. Everything stays in your browser—nothing is uploaded.</p>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-secondary leading-relaxed">List every size you need from that single photo—presets for social or your own exact widths and heights.</p>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-secondary leading-relaxed">Download all resized copies at once in one ZIP—each file named with its dimensions.</p>
            </div>
          </div>
        </section>
