        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 border border-stone-200 shadow-sm organic-glow">
          ...
          <div className="space-y-8 text-stone-700 font-body leading-relaxed">
            <section>
              ...
              <p>Welcome to MultiResize. We respect your privacy and are committed to protecting it. This Privacy Policy outlines what information we collect, how it is used, and how it is safeguarded when you use our image resizing tool.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-[#2d4d36] mb-4">1. Information We Do NOT Collect</h2>
              <p>MultiResize is designed as a client-side only application. This means:</p>
              <ul className="list-disc pl-6 mt-4 space-y-2">
                ...
                <li><strong>No Personal Data Required:</strong> You do not need to create an account, provide an email address, or give us any personal information to use MultiResize.</li>
              </ul>
            </section>
